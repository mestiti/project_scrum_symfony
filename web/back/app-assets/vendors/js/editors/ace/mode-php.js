...
var functionMap = {
    ...
    "array_diff_ukey": [
        ...
        "Returns the entries of arr1 that have keys which are not present in any of the others arguments. FosUser supplied function is used for comparing the keys. This function is like array_udiff() but works on the keys instead of the values. The associativity is preserved."
    ],
    "array_fill": [
    ...
    "ldap_dn2ufn": [
        ...
        "Convert DN to FosUser Friendly Naming format"
    ],
    "ldap_err2str": [
    ...
    "posix_getpwnam": [
        ...
        "FosUser database access (POSIX.1, 9.2.2)"
    ],
    "posix_getpwuid": [
